...
class SyncServiceClient extends $grpc.Client {
  static final _$scanFolder =
      $grpc.ClientMethod<$6.ScanFolderRequest, $6.ScanFolderResponse>(
          '/aether.api.SyncService/ScanFolder',
          ($6.ScanFolderRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.ScanFolderResponse.fromBuffer(value));
  static final _$syncFile =
      $grpc.ClientMethod<$6.SyncFileRequest, $6.SyncFileResponse>(
          '/aether.api.SyncService/SyncFile',
          ($6.SyncFileRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.SyncFileResponse.fromBuffer(value));
  static final _$getSyncStatus =
      $grpc.ClientMethod<$6.GetSyncStatusRequest, $6.SyncStatusResponse>(
          '/aether.api.SyncService/GetSyncStatus',
          ($6.GetSyncStatusRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.SyncStatusResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.ScanFolderResponse> scanFolder(
      $6.ScanFolderRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$scanFolder, request, options: options);
  }

  $grpc.ResponseFuture<$6.SyncFileResponse> syncFile($6.SyncFileRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$syncFile, request, options: options);
  }

  $grpc.ResponseFuture<$6.SyncStatusResponse> getSyncStatus(
      $6.GetSyncStatusRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSyncStatus, request, options: options);
  }

  $grpc.ResponseFuture<$1.Status> pauseSync($6.PauseSyncRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$pauseSync, request, options: options);
  }

  $grpc.ResponseFuture<$1.Status> resumeSync($6.ResumeSyncRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$resumeSync, request, options: options);
  }

  $grpc.ResponseStream<$6.SyncEvent> watchSyncEvents(
      $6.WatchSyncEventsRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SyncServiceBase extends $grpc.Service {
  ...
  SyncServiceBase() {
    $addMethod($grpc.ServiceMethod<$6.ScanFolderRequest, $6.ScanFolderResponse>(
        'ScanFolder',
        scanFolder_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.ScanFolderRequest.fromBuffer(value),
        ($6.ScanFolderResponse value) => value.writeToBuffer()));
    ...
    $addMethod(
        $grpc.ServiceMethod<$6.GetSyncStatusRequest, $6.SyncStatusResponse>(
            'GetSyncStatus',
            getSyncStatus_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.GetSyncStatusRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$6.WatchSyncEventsRequest, $6.SyncEvent>(
        ...
        true,
        ($core.List<$core.int> value) =>
            $6.WatchSyncEventsRequest.fromBuffer(value),
        ($6.SyncEvent value) => value.writeToBuffer()));
  }

  $async.Future<$6.ScanFolderResponse> scanFolder_Pre($grpc.ServiceCall call,
      $async.Future<$6.ScanFolderRequest> request) async {
    return scanFolder(call, await request);
  }

  $async.Future<$6.SyncFileResponse> syncFile_Pre(
      $grpc.ServiceCall call, $async.Future<$6.SyncFileRequest> request) async {
    return syncFile(call, await request);
  }

  $async.Future<$6.SyncStatusResponse> getSyncStatus_Pre($grpc.ServiceCall call,
      $async.Future<$6.GetSyncStatusRequest> request) async {
    return getSyncStatus(call, await request);
  }

  $async.Future<$1.Status> pauseSync_Pre($grpc.ServiceCall call,
      $async.Future<$6.PauseSyncRequest> request) async {
    return pauseSync(call, await request);
  }

  $async.Future<$1.Status> resumeSync_Pre($grpc.ServiceCall call,
      $async.Future<$6.ResumeSyncRequest> request) async {
    return resumeSync(call, await request);
  }

  $async.Stream<$6.SyncEvent> watchSyncEvents_Pre($grpc.ServiceCall call,
      $async.Future<$6.WatchSyncEventsRequest> request) async* {
    yield* watchSyncEvents(call, await request);
  }

  $async.Future<$6.ScanFolderResponse> scanFolder(
      $grpc.ServiceCall call, $6.ScanFolderRequest request);
  $async.Future<$6.SyncFileResponse> syncFile(
      $grpc.ServiceCall call, $6.SyncFileRequest request);
  $async.Future<$6.SyncStatusResponse> getSyncStatus(
      $grpc.ServiceCall call, $6.GetSyncStatusRequest request);
  $async.Future<$1.Status> pauseSync(
      $grpc.ServiceCall call, $6.PauseSyncRequest request);
  $async.Future<$1.Status> resumeSync(
      $grpc.ServiceCall call, $6.ResumeSyncRequest request);
  $async.Stream<$6.SyncEvent> watchSyncEvents(
      $grpc.ServiceCall call, $6.WatchSyncEventsRequest request);
}
